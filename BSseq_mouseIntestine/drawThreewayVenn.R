...
draw.triple.venn(area1, area2, area3, cross.area12, cross.area23, cross.area13, cross.area123, category=c(name1, name2, name3), main="test", cat.cex=2, cat.just = list(c(.5, .5), c(.5, .5), c(.5, .5)), cat.dist=c(.02,.02,.02), cat.default.pos="outer", cat.pos=c(0,180,180), cex=1.5, lwd=2*rep(magnify,3))
dev.off()
