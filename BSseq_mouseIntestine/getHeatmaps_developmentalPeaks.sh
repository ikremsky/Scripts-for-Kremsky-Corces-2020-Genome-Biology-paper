motif=All
region=distal
newDir=developmentalATACpeaks/
mkdir $newDir
cd $newDir
intersectBed -u -b allIntestineDevelopmentalPeaks.bed -a /media/4TB4/isaac/PGC_DNAseseq/bed/All/E14.5_male_pooled.sorted.duprmvdatfimo_All.notatIAPs.distalLo.fpkm > IntestinePeaks_E14.5mLo.bed
intersectBed -u -b allIntestineDevelopmentalPeaks.bed -a /media/4TB4/isaac/PGC_DNAseseq/bed/All/E14.5_male_pooled.sorted.duprmvdatfimo_All.distalHi.fpkm > IntestinePeaks_E14.5mHi.bed

HiFile=allIntestineDevelopmentalPeaks.bed
#IntestinePeaks_E14.5mHi.bed
#allIntestineDevelopmentalPeaks.bed
...
wait
wc -l *.me
fileEnd=_both.hiConfidence.E7.5meHi.me
R --vanilla --args ${motif}_developmentalPeaks ${fileEnd} E7.5${fileEnd} WTAdultIntestinalEpithelium${fileEnd} < ../getHeatmaps.R
for fileEnd in 
#_both.hiConfidence.E7.5meHi.DNAseHi.me _both.hiConfidence.E7.5meHi.DNAseLo.me _both.hiConfidence.E7.5meLo.DNAseHi.me _both.hiConfidence.E7.5meLo.DNAseLo.me
do
	R --vanilla --args ${motif}_developmentalCpGs_$(basename $fileEnd .me) ${fileEnd} E7.5${fileEnd} WTAdultIntestinalEpithelium${fileEnd} < ../getHeatmaps.R
done
