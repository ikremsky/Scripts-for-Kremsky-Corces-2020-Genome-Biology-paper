mkdir motifAnalysis_E7.5meHi_IntestinemeLo
cd motifAnalysis_E7.5meHi_IntestinemeLo
#awk '$4 < .2' ../developmentalATACpeaks/WTAdultIntestinalEpithelium_both.hiConfidence.E7.5meHi.me > E7.5mHi_reprogrammed.bed &
...
R --vanilla --args temp E7.5meHi_IntestinemeLo < ../getBarPlots_motifs.R
#intersectBed -u -a fimo.bed -b E7.5mHi_reprogrammed.bed | cut -f1-4 | grep Tcfap2a > fimo_E7.5meHi_IntestinemeLo_forigv.bed
echo done
