...
png(paste("barplot_", name, "_IAPs_motifCounts", ".png", sep=""), height = 2000, width = 2000, res=300)
par(lwd=2, las=1)
barplot(counts, width = 1, xlab="# of TFBSs at IAPs", ylim=c(0,64), names.arg=names, cex.axis=1.5, cex.lab=1.5, cex.names=1, horiz=T, space=1, col=myCol[logPs])
dev.off()
