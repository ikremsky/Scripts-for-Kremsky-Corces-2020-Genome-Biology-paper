align () {
	...
	tophat2 -p 20 --no-mixed --no-discordant -o $outDir -G /Zulu/isaac/PGC_RNAseq/gencode.vM20.annotation.gtf /home/genomefiles/human/bowtie2/mm10 ${file} $pair2
}
