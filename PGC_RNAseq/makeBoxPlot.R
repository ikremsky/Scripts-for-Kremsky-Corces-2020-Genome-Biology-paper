...
png(file="boxplots_DNAseVNRF1pks.png", height = 2000, width = 2000, res = 300)
par(mar=c(4.8,4.6,1.35,1.2), cex.axis = 2, cex.main=2, cex.sub = 1.8, cex.lab = 2, mgp = c(3,1.1,0), mex = 1.5)
#hist(data1[,5], breaks=50)
boxplot(x=list(data1[,5], data2[,5]), names=c("All DNAse", "NRF1 ChIP"), ylim=c(0,maxH+.25), ylab="TRAP affinity", outline=F, lwd=magnify)
box(lwd=magnify)
axis(1, at=c(1,2), lwd.ticks=magnify)
