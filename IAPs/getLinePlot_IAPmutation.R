...
plot(n, avg1, xlim=c(.5,length(x[,1])+.5), ylim=c(0, 1), xaxt='n', col="red", pch=15, xlab="", ylab="Mean meCpG/CpG", cex=2*magnify, lwd=magnify2, lwd.tick=magnify2)
...
legend("topleft",names,col=c("red", "blue", "black"), pch=c(15,0,1), cex=.75, pt.lwd=magnify2)
dev.off()
