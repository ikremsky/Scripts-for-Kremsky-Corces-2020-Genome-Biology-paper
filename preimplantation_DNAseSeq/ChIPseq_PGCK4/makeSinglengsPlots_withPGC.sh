...
do
	i=2
	for stage in E14.5m_DNAse-Hi e11.5PGC-H3K4me3 e11.5PGC-H3K27me3 e13.5PGC-H3K4me3 e13.5PGC-H3K27me3
	do
		testLab=$stage

		if [ $(echo $stage | awk '{if($1 ~ "E14.5m_DNAse-Hi") print 1; else print 0}') -eq 0 ]; then
			bamFile=bam/${stage}_pooled.sorted_distal.bam
			getFL
			stage=$(echo $stage | awk '{sub("e", "E"); print}')
