...
#files="/media/4TB4/isaac/PGC_DNAseseq/bed/${TF}/E14.5_male_pooled.sorted.duprmvdatfimo_${TF}.notatIAPs.distalHi.fpkm"
...
do
	i=2
	for stage in E14.5_male_PGC RS Sperm_ATAC Pronuclei_Pat_PN3 Pronuclei_Pat_PN5 2Cell 4Cell 8Cell Morula ICM ESC
...
ngs.plot.r -SC global -GO hc -G mm9 -R bed -C configurationFile.txt -F chipseq -XYL 0 -L 2500 -O ${type} -LWD 6
