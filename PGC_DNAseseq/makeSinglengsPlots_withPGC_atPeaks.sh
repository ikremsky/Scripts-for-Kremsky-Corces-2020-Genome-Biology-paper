...
TF=All
region=distal
files="/media/4TB4/isaac/PGC_DNAseseq/bed/${TF}/E13.5-16.5_male_persistent.${region}Hi.fpkm /media/4TB4/isaac/PGC_DNAseseq/bed/${TF}/E13.5-16.5_male_persistent.${region}Lo.fpkm"
#"/media/4TB4/isaac/PGC_DNAseseq/persistentPeaks_maleSpecific.center.bed /media/4TB4/isaac/PGC_DNAseseq/E13.5not14.5m.center.bed"
...
do
	i=2
	for stage in E9.5_PGC E10.5_PGC E12.5_male_PGC E13.5_male_PGC E14.5_male_PGC E16.5_male_PGC
