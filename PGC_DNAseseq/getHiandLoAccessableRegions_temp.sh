...
do
	...
	file=$(ls ${type}*fpkm | grep -v Lo | grep -v Hi | grep -v distal | grep -v genuine)
	...
	intersectBed -v -a $(basename $file .fpkm).genuine.fpkm -b /mnt/isaachd/annotations/TSSs_500bparouns_mm9.bed > $(basename $file .fpkm).distal.fpkm
...
intersectBed -v -a E13.5-16.5_male_persistent.Hi.fpkm -b /mnt/isaachd/annotations/TSSs_500bparouns_mm9.bed > E13.5-16.5_male_persistent.distalHi.fpkm
...
intersectBed -v -a E13.5-16.5_male_persistent.Lo.fpkm -b /mnt/isaachd/annotations/TSSs_500bparouns_mm9.bed > E13.5-16.5_male_persistent.distalLo.fpkm
...
intersectBed -v -a E14.5m_gained.fpkm -b /mnt/isaachd/annotations/TSSs_500bparouns_mm9.bed > E14.5m_gained.distal.fpkm
...
intersectBed -v -a E14.5m_lost.fpkm -b /mnt/isaachd/annotations/TSSs_500bparouns_mm9.bed > E14.5m_lost.distal.fpkm
intersectBed -u -a E14.5m_lost.fpkm -b /mnt/isaachd/annotations/TSSs_500bparouns_mm9.bed > E14.5m_lost.proximal.fpkm
wait

intersectBed -u -a E14.5_male_pooled.sorted.duprmvdatfimo_${TF}.distal.fpkm -b E9.5_pooled.sorted.duprmvdatfimo_${TF}.distalHi.fpkm | awk '$NF < 12' > E9.5Hi_E14.5mLo.distal.fpkm
...
intersectBed -u -a E9.5_pooled.sorted.duprmvdatfimo_${TF}.distal.fpkm -b E14.5_male_pooled.sorted.duprmvdatfimo_${TF}.distalHi.fpkm | awk '$NF < 12' > E9.5Lo_E14.5mHi.distal.fpkm
