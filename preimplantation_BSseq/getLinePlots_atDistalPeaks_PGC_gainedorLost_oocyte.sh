...
region=distal
compareStage=E9.5_E14.5m_oocyte
TF=All

name1="E9.5-trace | E14.5m-Hi"
name2="E9.5-Hi | E14.5m-trace"

pkFile=/media/4TB4/isaac/PGC_DNAseseq/bed/${TF}/E9.5Lo_E14.5mHi.distal.fpkm
ctrlFile=/media/4TB4/isaac/PGC_DNAseseq/bed/${TF}/E9.5Hi_E14.5mLo.distal.fpkm
...
do
	...
	rm avgme.txt
	for bedFile in $(ls bed/*mm9.bed | grep -v + | grep -v - | grep -v hmc | grep -e sperm -e ocyt)
	do
