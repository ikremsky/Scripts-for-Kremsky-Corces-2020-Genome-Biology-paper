...
pkFile=/media/4TB4/isaac/PGC_DNAseseq/bed/${motif}/E14.5_male_pooled.sorted.duprmvdatfimo_${motif}.distalLo.fpkm
intersectBed -u -a $pkFile -b /Zulu/isaac/starvation_sperm/mm9_IAPs.bed > IAPTFBSs.bed
intersectBed -v  -a $pkFile -b /Zulu/isaac/starvation_sperm/mm9_IAPs.bed > nonIAPTFBSs.bed
pkFile=IAPTFBSs.bed
ctrlFile=nonIAPTFBSs.bed
